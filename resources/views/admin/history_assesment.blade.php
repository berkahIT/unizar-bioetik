          ...
          <div class="card-body">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <p class="small">Silahkan Masukkan Data History Assesment</p>
            ...
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                <td></td>
                <td>
                    <a href="/admin/history_assesment/1/edit"><i class="fas fa-edit"></i></a> |
                    <form action="/admin/history_assesment/1" method="post" class="d-inline">
                        @method('delete')
                        @csrf
