          ...
          <div class="card-body">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form action="/rekam_medik" method="POST">
                                @csrf
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <div class="form-group">
                                            <label for="exampleFormControlSelect1">Konselor</label>
                                            <select class="form-control" id="konselor" name="konselor">
                                                <option value=""><i>Konselor</i></option>
                                        ...
                                        <div class="form-group">
                                            <label for="rekam_medik">Rekam Medik</label>
                                            <input type="file" class="form-control" id="rekam_medik" name="rekam_medik" placeholder="Rekam Medik">
                                        </div>
                                    </div>
            ...
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                <td></td>
                <td>
                    <a href="/admin/rekam_medik/1/edit"><i class="fas fa-edit"></i></a> |
                    <form action="/admin/rekam_medik/1" method="post" class="d-inline">
                        @method('delete')
                        @csrf
