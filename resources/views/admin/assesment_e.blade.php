    ...
    <div class="row">
      <div class="col-12">
        ...
        <div class="card">
          ...
          <!-- /.card-header -->
          <div class="card-body">
            <form action="/assesment" method="POST">
                @csrf
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="form-group">
                            <label for="akses">Akses Assesment</label>
                            <input type="number" class="form-control" id="akses" name="akses" placeholder="Akses Assesment">
                        </div>
                    </div>
                </div>
