          ...
          <div class="card-body">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <p class="small">Silahkan Masukkan Data kritik_saran</p>
                            <form action="/kritik_saran" method="POST">
                                @csrf
                                <div class="row">
                                    <div class="col-sm-12">
            ...
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                <td></td>
                <td>
                    <a href="/admin/kritik_saran/1/edit"><i class="fas fa-edit"></i></a> |
                    <form action="/admin/kritik_saran/1" method="post" class="d-inline">
                        @method('delete')
                        @csrf
